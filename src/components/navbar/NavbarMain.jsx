...
const NavbarMain = () => {
  ...
  return (
    <nav className="max-w-[1300px] mx-auto w-full px-4 flex gap-4 mt-2 relative">
      ...
      {menuOpen && (
        <div className="absolute top-full left-0 w-full bg-black border-t border-orange z-30 p-6 flex flex-col items-center gap-6 lg:hidden animate-fade-in">
          <NavbarLinks />
        </div>
      )}
    </nav>
