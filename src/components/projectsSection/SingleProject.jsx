  ...
  return (
    ...
    >
      <div>
        ...
        <p className="text-[#bdbdbd] text-sm mt-2 mb-3 max-w-md">
          {getProjectDescription(name)}
        </p>
        <a
          href={link}
          className={`text-lg flex gap-2 items-center text-accent hover:text-highlight transition-all duration-500 cursor-pointer sm:justify-self-center ${
